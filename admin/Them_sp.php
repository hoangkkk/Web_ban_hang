<form name="form1" method="post" action="process.php">
  ...
  <table width="800" border="0" cellspacing="0">
    <tr>
      ...
      <input name="tensp" type="text" id="tensp" size="100" /></td>
    </tr>
    <tr>
      <th scope="row">Giá:</th>
      <td><label for="gia"></label>
      <input name="gia" type="text" id="gia" size="100" /></td>
    </tr>
    <tr>
      <th scope="row">Mô Tả:</th>
      <td><label for="MoTa"></label>
        <label for="MoTa"></label>
      <textarea name="MoTa" id="MoTa" cols="100" rows="5"></textarea></td>
    </tr>
    <tr>
      <th scope="row">Ghi Chú:</th>
      <td><label for="Ghichu"></label>
      <textarea name="Ghichu" id="Ghichu" cols="100" rows="5"></textarea></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <input name="hinh" type="text" id="hinh" size="100" /></td>
    </tr>
    <tr>
    <th scope="row" colspan="2"><input type="submit" name="Them_sp" id="Them_sp" value="Thêm" /></th>
    </tr>
